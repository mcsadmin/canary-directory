...
| Unit | Target Day | Purpose |
|---|---|---|
| Meta-canary (QR code generator) | Thursday evening (12 Mar) | Rehearse and validate the working method; produce refined prompts and improved coaching master prompt |
| Project canary (Directory / verified nodes) | Friday (13 Mar) | End-to-end build of the Directory component; document any changes to the working method |
| Requirements and specification sessions | Saturday (14 Mar) | BDD specifications, data model, test harnesses |
| Build sessions | Sunday–Monday (15–16 Mar) | AI-agent-directed coding within defined scope |
| Review and testing sessions | Throughout build days | Verify integrity constraints and test coverage |
| Deployment | Tuesday (17 Mar) | Deploy sandbox to `sandbox.localloop-merseyside.co.uk` |

---

## 7. Confirmed Technical Decisions

The following technical decisions have been confirmed for the experiment week:

| Decision | Confirmed Choice | Notes |
|---|---|---|
| Coding tool | **Cursor Pro** (two licences) | Replit ruled out during meta-canary; Claude Code held in reserve |
| Ticket management | **Linear** (via MCP integration in Cursor) | Tickets generated from BDD specifications |
| Unit and integration testing | **Vitest** | Scaffolded before any feature code is written |
| End-to-end testing | **Playwright** | Requires Railway deployment to be live before running |
| Database | **PostgreSQL on Railway** | See database position paper in `/planning/` |
| Graph architecture | Relational (PostgreSQL schema) | Graph traversal not a current requirement; Apache AGE noted as future option |
| Version control | **GitHub** (direct commits from Cursor) | Verbose commit bodies mandatory |
| Publication layer | **Gitbook** | Connected to the repository; `SUMMARY.md` must be kept in sync |

---

## 8. The Working Method in Summary
...
*Prepared by Manus AI, 12 March 2026. Updated 13 March 2026: Section 7 (Confirmed Technical Decisions) added — Cursor Pro, Linear MCP, Vitest, Playwright, PostgreSQL on Railway.*
